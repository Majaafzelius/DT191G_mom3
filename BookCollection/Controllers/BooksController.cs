...
namespace BookCollection.Controllers
{
    public class BooksController : Controller
    {
        ...
        public BooksController(BookCollectionContext context)
        {
            _context = context;
        }
        ...
        {
            var bookCollectionContext = _context.Book.Include(b => b.Author);
            return View(await bookCollectionContext.ToListAsync());
        }
